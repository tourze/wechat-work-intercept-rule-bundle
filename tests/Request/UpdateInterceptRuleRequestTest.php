 ...
 * @internal
 */
#[CoversClass(UpdateInterceptRuleRequest::class)]
final class UpdateInterceptRuleRequestTest extends RequestTestCase
{
    ...
    public function testAddApplicableUserListSetterAndGetter(): void
    {
        // 测试新增用户列表设置和获取
    ...
    public function testAddApplicableUserListNullValue(): void
    {
        // 测试新增用户列表为null
    ...
    public function testAddApplicableUserListEmptyArray(): void
    {
        // 测试新增用户列表为空数组
        $emptyList = [];
    ...
    public function testAddApplicableDepartmentListSetterAndGetter(): void
    {
        // 测试新增部门列表设置和获取
    ...
    public function testAddApplicableDepartmentListNullValue(): void
    {
        // 测试新增部门列表为null
    ...
    public function testRemoveApplicableUserListSetterAndGetter(): void
    {
        // 测试移除用户列表设置和获取
    ...
    public function testRemoveApplicableUserListNullValue(): void
    {
        // 测试移除用户列表为null
    ...
    public function testRemoveApplicableDepartmentListSetterAndGetter(): void
    {
        // 测试移除部门列表设置和获取
        $deptList = [100, 200];
    ...
    public function testRemoveApplicableDepartmentListNullValue(): void
    {
        // 测试移除部门列表为null
    ...
    public function testAgentMethods(): void
    {
        ...
        $this->assertSame('agent_456', $agent->getAgentId());
        $this->assertSame('Hello World!', $agent->getWelcomeText());
    ...
    public function testGetRequestOptionsBasicUpdate(): void
    {
        // 测试基本更新的请求选项
    ...
    public function testGetRequestOptionsUpdateRuleName(): void
    {
        // 测试更新规则名称
    ...
    public function testGetRequestOptionsUpdateWordList(): void
    {
        // 测试更新敏感词列表
    ...
    public function testGetRequestOptionsUpdateInterceptType(): void
    {
        // 测试更新拦截类型
    ...
    public function testGetRequestOptionsUpdateSemanticsList(): void
    {
        // 测试更新语义规则列表
    ...
    public function testGetRequestOptionsAddUserList(): void
    {
        // 测试添加用户列表
    ...
    public function testGetRequestOptionsAddDepartmentList(): void
    {
        // 测试添加部门列表
    ...
    public function testGetRequestOptionsRemoveOperations(): void
    {
        // 测试删除操作
    ...
    public function testGetRequestOptionsComprehensiveUpdate(): void
    {
        // 测试全面更新
    ...
    public function testBusinessScenarioUpdateRuleName(): void
    {
        // 测试业务场景：更新规则名称
    ...
    public function testBusinessScenarioAddNewUsers(): void
    {
        // 测试业务场景：为现有规则添加新用户
    ...
    public function testBusinessScenarioExpandDepartments(): void
    {
        // 测试业务场景：扩展部门范围
    ...
    public function testBusinessScenarioUpdateSensitiveWords(): void
    {
        // 测试业务场景：更新敏感词库
    ...
    public function testBusinessScenarioChangeInterceptStrategy(): void
    {
        // 测试业务场景：改变拦截策略
    ...
    public function testBusinessScenarioUpdateSemantics(): void
    {
        // 测试业务场景：更新语义拦截规则
    ...
    public function testRuleIdRequiredForUpdate(): void
    {
        // 测试更新操作需要规则ID
    ...
    public function testMaxSizeArrays(): void
    {
        // 测试最大大小数组（1000个节点）
        $largeUserList = [];
        for ($i = 1; $i <= 1000; ++$i) {
        ...
        $addUserList = $this->request->getAddApplicableUserList();
        $addDeptList = $this->request->getAddApplicableDepartmentList();
        $removeUserList = $this->request->getRemoveApplicableUserList();
        $removeDeptList = $this->request->getRemoveApplicableDepartmentList();

        $this->assertNotNull($addUserList);
        $this->assertNotNull($addDeptList);
        $this->assertNotNull($removeUserList);
        $this->assertNotNull($removeDeptList);

        $this->assertCount(1000, $addUserList);
        $this->assertCount(1000, $addDeptList);
        $this->assertCount(1000, $removeUserList);
        $this->assertCount(1000, $removeDeptList);
    }
    ...
    public function testSpecialCharactersInRuleId(): void
    {
        // 测试规则ID中的特殊字符
        $specialRuleIds = [
            'rule@domain.com',
